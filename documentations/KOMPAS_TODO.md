...
- [ ] Faza 6: sedam admin celina, lifecycle i isti preview Engine postoje; nedostaju autentifikovani admin browser test i potpuniji editor svih flow polja/actor evidence prikaz. **U toku (2026-08-05):** article authoring editor (PR1+PR2 — 5-step stepper, NextActionCard, ArticleChecklist, article-specific field adapteri). PR3 (oblast/tema/Kompas pitanja) i PR4 (pregled i produkcioni gate) slede.

...
- [ ] R2 Booking Engine.
- [ ] **Kompas — K1 foundation + K2.0 route registry završeni 2026-07-31:** kanonski registar, migracija D-052 oblasti, lifecycle/audit, staff/public API, locale-aware kanonske putanje, sačuvani 308 aliasi i OpenAPI klijent postoje. D-054 razdvaja kanonske stranice oblasti/tema od dinamičkog prikaza; slede K2 panel sa tabom „Oblasti” → kontrolisana CMS polja → K3B javni renderer/`CompassGuide` → recommendation/public Kompas. Basic/advanced granica i release mapa ostaju O-21.

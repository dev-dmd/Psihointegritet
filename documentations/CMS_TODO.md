...
- [x] **Save + velika dokumenta (drugi živi test):** `UndefinedColumnError` za `legal_documents.slug` pokazao je da lokalna development baza nije dobila migraciju `20260730_0009`; migracija je primenjena. Rich editor je ograničen na 500 px uz interni panel scrollbar, a shared `ErrorBanner` se automatski skroluje do prijavljene greške.

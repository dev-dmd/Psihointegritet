...
- [ ] R2 Booking Engine.
- [ ] **Kompas — K1 backend foundation završen 2026-07-31:** kanonski registar, migracija D-052 oblasti, lifecycle/audit, staff/public API i OpenAPI klijent postoje. D-054 razdvaja kanonske stranice oblasti/tema od dinamičkog prikaza; slede K2.0 javni route registry + K2 panel sa tabom „Oblasti” → kontrolisana CMS polja → K3B kanonski read-model/`CompassGuide` → recommendation/public Kompas. Basic/advanced granica i release mapa ostaju O-21.

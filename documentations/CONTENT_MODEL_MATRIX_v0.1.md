...
>
> **O-24a je zatvoren D-052 (2026-07-30):** Intake & Matching koristi pet stabilnih `areas` ID-jeva, zajednički parity fixture i migrirane DB profile; „zavisnost" je Anjina potvrđena uža capability oznaka sa timskim handoff-om. Javni čipovi profila ostaju prezentacioni sadržaj, ne matching izvor. **O-24b je zatvoren D-053/ADR-022 (2026-07-31):** managed topic group/topic/audience/goal registri, zaključane system journey/format/access vrednosti, revision-bound content metadata i eksplicitni most ka Intake rečniku sada su dozvoljeno proširenje ove matrice. Konačne Anjine kategorije su DB podaci i ne blokiraju backend foundation.
>

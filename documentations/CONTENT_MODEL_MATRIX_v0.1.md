...
>
> **O-24a je zatvoren D-052 (2026-07-30):** Intake & Matching koristi pet stabilnih `areas` ID-jeva, zajednički parity fixture i migrirane DB profile; „zavisnost" je Anjina potvrđena uža capability oznaka sa timskim handoff-om. Javni čipovi profila ostaju prezentacioni sadržaj, ne matching izvor. **O-24b je razrađen u `KOMPAS_TODO.md` (2026-07-31):** odvojene topic group/topic/journey/goal/audience ose, revision-bound content metadata i eksplicitni most ka Intake rečniku. Pre implementacije i dalje traži D-053/ADR-022 i Anjine konačne seed podatke.
>

    ...
    <PageHero id="tim">
      <div className="max-w-[680px]">
        ...
        <p className="text-coffee/72 text-[16.5px] leading-[1.65]">
          Psihointegritet čine stručnjaci sa različitim iskustvima i pristupima,
          ujedinjeni istim principima geštalt psihoterapije — poverljivost,
          prisutnost i poštovanje vašeg tempa. Pogledajte pristup i oblasti rada
          svakog terapeuta i izaberite osobu koja vam uliva poverenje.
        </p>
      </div>
    </PageHero>
  );
